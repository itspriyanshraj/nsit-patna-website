...
import styles from "../infrastructure/infrastructurePages.module.css";

const infrastructureLinks = [
  ["Library", "/library-details"],
  ["Computing Resource", "/infrastructure/computing"],
  ["Lab", "/infrastructure/lab"],
  ["Classroom", "/infrastructure/classroom"],
...
export default function LibraryPage() {
  return (
    <SectionShell section="Infrastructure" activePath="/library-details" title="Library" links={infrastructureLinks}>
      <div className={styles.infoCard}>
        ...
        <img loading="lazy" src="https://www.nsit.in/Content/assets/c_images/library.png" alt="NSIT Library" className={styles.infoCardImage} />
      </div>
