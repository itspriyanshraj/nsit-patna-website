    ...
    <SectionShell section="Placement" activePath="/placement/about" title="About T &amp; P" links={placementLinks}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center', marginTop: 28 }}>
        ...
        <div style={{ flex: '0 0 auto', borderRadius: 14, overflow: 'hidden', boxShadow: '0 12px 40px rgba(23,32,51,0.12)', width: 'clamp(240px,28vw,380px)' }}>
          <img src="https://www.nsit.in/Content/assets/c_images/AboutTandP/bridge-jobs.jpg" alt="Bridge between you and your first job" style={{ width: '100%', height: 'auto', display: 'block' }} />
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center', marginTop: 40, flexDirection: 'row-reverse' }}>
        ...
        <div style={{ flex: '0 0 auto', borderRadius: 14, overflow: 'hidden', boxShadow: '0 12px 40px rgba(23,32,51,0.12)', width: 'clamp(240px,28vw,380px)' }}>
          <img src="https://www.nsit.in/Content/assets/c_images/AboutTandP/NSIT_Flagship_Training.jpg" alt="NSIT Flagship Training" style={{ width: '100%', height: 'auto', display: 'block' }} />
        </div>
      </div>
      ...
      <div style={{ marginTop: 40, borderRadius: 14, border: '1px solid var(--border-color)', overflow: 'hidden', background: '#fff' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, padding: 24 }}>
          <div style={{ flex: '0 0 auto', borderRadius: 12, overflow: 'hidden', width: 'clamp(200px,25vw,340px)' }}>
            <img src="https://www.nsit.in/Content/assets/c_images/AboutTandP/Rojgar_utsav.jpg" alt="Rojgar Utsav 2015" style={{ width: '100%', height: 'auto', display: 'block' }} />
          </div>
          <div style={{ flex: '1 1 300px' }}>
          ...
          <div key={p.name} style={{
            ...
            {p.img && (
              <div style={{ flex: '0 0 auto', borderRadius: 10, overflow: 'hidden', width: 'clamp(200px,22vw,300px)' }}>
                <img src={p.img} alt={p.full} style={{ width: '100%', height: 'auto', display: 'block' }} />
              </div>
            )}
