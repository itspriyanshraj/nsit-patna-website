      ...
      <div className={styles.infoCard}>
        <div className={styles.infoCardHeader}>
          <div className={styles.infoCardIcon}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>
          </div>
          <h3 className={styles.infoCardTitle}>SmartClass: College Learning Hubs</h3>
        </div>
        ...
        <img loading="lazy" src="https://www.nsit.in/Content/assets/c_images/nsit_images/nsitclassroom.png" alt="NSIT Classroom" className={styles.infoCardImage} />
      </div>
    </SectionShell>
  );
}
