...
export default function AboutUsPage() {
  return (
    <InstitutionShell activePath="/about-us" title="About Us">
      <section className={styles.introGrid}>
        <div className={styles.media}>
          <img src="/vertical.png" alt="About NSIT" style={{width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', inset: 0}} loading="lazy" />
        </div>
